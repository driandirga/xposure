        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <a href="{{ route('master.warehouses.create') }}" class="btn btn-primary btn-sm font-weight-bold text-xs float-end"
                                ...
                                @foreach ($warehouses as $k => $warehouse)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('master.warehouses.edit', $warehouse->id) }}"
                    ...
                    success: function(result) {
                        if (result) {
                            ...
                            Swal.fire(
                                ...
                                window.location.href = "{{ route('master.warehouses.index') }}";
                            });
                        }
